...
public class BookForm extends javax.swing.JFrame {
    private static final String UBUNTU_FONT= "Ubuntu";
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N
        jLabel1.setText("Book Name");

        jLabel3.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N
        jLabel3.setText("Publisher");

        jLabel4.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N
        jLabel4.setText("Author");

        jLabel5.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N
        jLabel5.setText("Book Pos");

        jLabel6.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N
        jLabel6.setText("Shelf");

        jLabel7.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N
        jLabel7.setText("Row");

        BookName.addActionListener(this::BookNameActionPerformed);

        Publisher.addActionListener(this::PublisherActionPerformed);

        Author.addActionListener(this::AuthorActionPerformed);

        Row.addActionListener(this::RowActionPerformed);

        Shelf.addActionListener(this::ShelfActionPerformed);

        jButton1.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N
        ...
        jLabel2.setFont(new java.awt.Font(UBUNTU_FONT, Font.PLAIN, 20)); // NOI18N

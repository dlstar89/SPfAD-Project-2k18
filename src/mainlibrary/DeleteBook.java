...
public class DeleteBook extends javax.swing.JFrame {
    ...
    private static final String FONT_UBUNTU = "FONT_UBUNTU";
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font(FONT_UBUNTU, Font.PLAIN, 20)); // NOI18N
        jLabel1.setText("Book ID");

        jLabel2.setFont(new java.awt.Font(FONT_UBUNTU, Font.PLAIN, 20)); // NOI18N
        jLabel2.setText("Password");

        jButton1.setFont(new java.awt.Font(FONT_UBUNTU, Font.PLAIN, 20)); // NOI18N
        jButton1.setText("Delete");
        jButton1.addActionListener(this::jButton1ActionPerformed);

        jButton2.setFont(new java.awt.Font(FONT_UBUNTU, Font.PLAIN, 18)); // NOI18N
        jButton2.setText("Back");
        jButton2.addActionListener(this::jButton2ActionPerformed);

        jLabel3.setFont(new java.awt.Font(FONT_UBUNTU, Font.PLAIN, 20)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (LibrarianDao.validate(UserName.getText(), pass)) {
            ...
            } else if (BookDao.Delete(bookIDV) != 0) {
